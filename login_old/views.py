...
from login_old.models import User
...
class CreateForm(forms.Form):
    ...
    instance_amount = forms.CharField(label='实例数：', max_length=100)
...
#             instance_amount = uf.cleaned_data['instance_amount']
#             data={
#                     "service_name":"myweb",
#                     "image_name":"ubuntu",
#                     "instance_amount":"1",
...
def swarm(request):
    uf = CreateForm()
    de_uf=DeleteForm()
    return render_to_response('docs/examples/navbar/index.html')
#/Users/tengyu/work/weitac/weitac_gateway/static/docs/examples/navbar/index.html
#    return render_to_response('docs/examples/navbar/index.html', {'uf': uf,'de_uf':de_uf})
